                    ...
                    'item': [
                        {
                            ...
                            'callback': (val) => {
                                Il2Cpp.perform(() => {
                                    ...
                                    lib.class('Proto.MPtTaskNewUpdate').method('Send').invoke(40206, 1);
                                    lib.class('Proto.MptNoobFinishExchangeTask').method('Send').invoke(40206);
                                    lib.class('Proto.MPtTaskNewReceive').method('Send').invoke(40206, 13);
                                });
                            }
                        },
                        {
